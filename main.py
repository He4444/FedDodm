...
def run(args):
    ...
    for i in range(args.prev, args.times):
        ...
        if model_str == "mlr":  # convex
            ...
            args.model = SimpleCNN(in_features=3, num_classes=args.num_classes, dim=1600).to(args.device)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-dev', "--device", type=str, default="cuda",
                        choices=["cpu", "cuda"])
    parser.add_argument('-did', "--device_id", type=str, default="3")
    ...
    parser.add_argument('-algo', "--algorithm", type=str, default="FedDodm")
